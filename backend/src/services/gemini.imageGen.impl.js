...
export class ImageGenImpl extends ImageGeneration {
 ...
 constructor(model , config) {
  ...
  async generateImage(conciserText) {
    ...
    const result = await this.ai.models.generateContent({ // this thing fucks up the image sometimes. and it does nt have the idea who the characters are.. so generates random people.
      model: this.model,
      contents: prompt,
      config: {
